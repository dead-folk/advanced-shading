Shader "Deadfolk/Advanced Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.deadfolk.advancedshading/ShaderLibrary/LitInput.hlsl"
            #include "Packages/com.deadfolk.advancedshading/ShaderLibrary/Lighting.hlsl"
            #include "Packages/com.deadfolk.advancedshading/ShaderLibrary/LitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Packages/com.deadfolk.advancedshading/ShaderLibrary/LitGBufferPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "Deadfolk.AdvancedShading.Editor.AdvancedLitGUI"
